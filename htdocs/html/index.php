...
<body class="pageHome">
  ...
  <div class="container">
    <div class="container__main">
        ...
        <div class="qaListContainer">
          <ul class="qaList">
            <li class="qaList__item">
              <a href="#" class="qaList__itemInner">
                <div class="qaList__itemEyecatch" style="background-image: url('/assets/images/sample.jpg');">
      ...
      <section class="container__mainSection">
        <a href="#" target="_blank"><img src="/assets/images/ad.jpg"></a>
      </section>
