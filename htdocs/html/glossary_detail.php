        ...
        <div class="glossaryDetail">
          ...
          <ul class="glossaryNavi">
            <li class="glossaryNavi__item">
              <a href="#groupA" class="scroll">あ行</a>
            </li>
            <li class="glossaryNavi__item">
              <a href="#">か行</a>
            </li>
          ...
          <div class="glossaryDetail__container">
            <h1 class="glossaryDetail__title">育児休暇はもらえますか？またその条件はありますか</h1>
            <p>
            ...
            <div class="glossaryDetail__back">
              <a href="#" class="button">
                <div class="button__inner button__inner--back">
                  戻る
                </div>
              </a>
            </div>
