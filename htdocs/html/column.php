    ...
    <div class="container__main">
      <section class="container__mainSection">
        <div class="article">
          ...
          <div class="article__eyecatch">
            ...
            <div class="article__category" style="background-color: #5360db;">お知らせ</div>
          </div>
          <div class="article__container">
            ...
            <section class="article__body">
              ...
              <div class="buttonContainer">
                <a href="#" class="button button--green"><span class="button__inner">説明会に参加する</span></a>
              </div>
              ...
              <div class="article__bodyFooter">
                ...
                <div class="contentBlock">
                  <ul class="article__bodyFooterCategory">
                    <li>
                      <a href="#"><span class="Icon -twitter"></span>お知らせ</a>
                    </li>
                  </ul>
                </div>
      ...
      <section class="container__mainSection">
        <div class="contentTitle">
          <h2 class="contentTitle__main">関連するコラム</h2>
